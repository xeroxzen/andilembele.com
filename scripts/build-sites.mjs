...
await writeFile(new URL('admin/index.html',out),`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta name="robots" content="noindex,nofollow"><title>Admin · Andile Jaden Mbele</title><link rel="stylesheet" href="/styles.css"><link rel="stylesheet" href="/blog/blog.css"></head><body><div class="page"><header class="topbar"><a class="wordmark" href="/">ajm.</a><a href="/blog">Writing</a></header><main><section class="blog-head"><p class="eyebrow">Private workspace</p><h1>Admin.</h1><p class="notice">Online administration is not connected yet.</p><p class="about">The local workspace supports posts, drafts, previews, images, and backups. Sign-in and online publishing will be available after the owner connects the backend.</p></section><section class="admin-panel"><h2>Owner setup</h2><p>Connect your own hosting, administrator authentication, database, and media storage. Follow the setup guide included with the website repository.</p><p>No drafts or editing controls are exposed on this public page.</p><a href="/">Back to website →</a></section></main></div></body></html>`);
