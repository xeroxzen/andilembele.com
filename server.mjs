...
export function createHandler({directory=fileURLToPath(new URL('./data/',import.meta.url)),port=4173}={}){
...
return async(req,res)=>{try{
 ...
 if(req.method==='GET'){
 if(pathname==='/api/session')return json(res,{token:csrf,mode:'local'});
